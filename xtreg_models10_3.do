permute lo_immigrant_dup _b, reps(5000) seed(10) strata(org2): ///	
	xtreg lo_immigrant_dup c.stdlagconabst_pol2_dup##(c.terror_nr c.kill_nr c.legal_nr) ///
...
mat rownames p_model3 = stdlagconabst_pol2_dup terror_nr kill_nr legal_nr ///
	c.stdlagconabst_pol2_dup#c.lo_pop c.stdlagconabst_pol2_dup#c.kill_nr c.stdlagconabst_pol2_dup#c.lo_legal ///
	laglo_immigrant_dup teror_r kill_r per_repub1_dup 1.catpage 2.catpage 3.catpage ///

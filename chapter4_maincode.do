...
permute lo_immigrant_dup _b, reps(1000) seed(10) strata(org2): ///
	xtreg lo_immigrant_dup terror_nr if dupflag==1, fe 
		
set seed 10
permute lo_immigrant_dup _b, reps(1000) seed(10) strata(org2): ///
	xtreg lo_immigrant_dup c.stdlagconabst_pol2_dup##c.terror_nr ///
		if dupflag==1, fe 
...
*Descriptive stats for full model
univar lo_immigrant_dup stdlagconabst_pol2_dup terror_nr legal_nr ///
		laglo_immigrant_dup terror_r per_repub1_dup lo_vcrime_rate ///
		stdleadpublic_dup reform p2001 logvocality_dup word_count_dup ///
		if dupflag==1
tab catpage if dupflag==1
tab admin42 if dupflag==1
